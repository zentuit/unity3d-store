...
namespace Soomla
{
	...
	public class StoreInventory
	{
		...
		public static void GiveItem(string itemId, int amount) {
			StoreUtils.LogDebug(TAG, "SOOMLA/UNITY Calling GiveItem with itemId: " + itemId + " and amount: " + amount);
		...
		public static void TakeItem(string itemId, int amount) {
			StoreUtils.LogDebug(TAG, "SOOMLA/UNITY Calling TakeItem with itemId: " + itemId + " and amount: " + amount);
