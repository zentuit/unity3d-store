...
[soomla-unity3d-core v1.0.3](http://library.soom.la/fetch/unity3d-core/1.0.4?cf=github)  
[unity3d-store v1.7.8](http://library.soom.la/fetch/unity3d-store/1.7.9?cf=github)
...
1. Download the [soomla-unity3d-core](http://library.soom.la/fetch/unity3d-core/1.0.4?cf=github) and [unity3d-store](http://library.soom.la/fetch/unity3d-store/1.7.8?cf=github) unitypackages and double-click on them (first 'Core' then 'Store'). It'll import all the necessary files into your project.
