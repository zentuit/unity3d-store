...
namespace SoomlaWpCore.rewards {	
	...
	public class VirtualItemReward : Reward {
		...
		public VirtualItemReward(JSONObject jsonReward)
			: base(jsonReward)
		{
            AssociatedItemId = jsonReward[SoomlaWpStore.data.StoreJSONConsts.VIR_ASSOCITEMID].str;
            Amount = (int)jsonReward[SoomlaWpStore.data.StoreJSONConsts.VIR_AMOUNT].n;
		}
		...
		public override JSONObject toJSONObject() {
            ...
            obj.AddField(SoomlaWpStore.data.StoreJSONConsts.VIR_ASSOCITEMID, AssociatedItemId);
            obj.AddField(SoomlaWpStore.data.StoreJSONConsts.VIR_AMOUNT, Amount);
			obj.AddField(SoomlaWpCore.data.JSONConsts.SOOM_CLASSNAME, GetType().Name);
		...
		protected override bool takeInner() {
			...
			try {
				StoreInventory.TakeVirtualItem(AssociatedItemId, Amount);
			} catch (VirtualItemNotFoundException e) {
